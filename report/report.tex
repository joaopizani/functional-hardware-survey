...
\begin{document}
    ...
    \label{sec:edsls}
        ...
        \subsection{Coquet}
        \label{subsec:coquet}
            The third analyzed EDSL for hardware description, Coquet, % ref here
            is strikingly different from both others. Most of these differences can be explained in
            one way or another by its choice of host ``language'' -- Coq. % note: Coq isn't a lang
    ...
    Inductive vec A : nat -> Type :=
        ...
        |cons : forall (h : A) (n : nat),  vec A n -> vec A (S n).
            ...
            useful properties of functions operating on vector. In fact, the type-system of Coq is
            ...
            in Coq, and to use it to prove interesting properties about these circuits. This is
            exactly the goal of Coquet. How this goal is achieved and the modelling of our studied
            circuits in Coquet is discussed in the following subsections.
