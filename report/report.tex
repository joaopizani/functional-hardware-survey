...
\begin{document}
    ...
    \label{sec:methods}
        ...
        \label{subsec:aspects}
            ...
            \begin{itemize}
                \item Capability/ease of simulation
                \item Capability/ease of verification (of formal properties)
                \item Capability to express generic (parameterized) families of circuits
                    \subitem Parameterized by functional as well as non-functional parameters
                \item Integration with other tools (implementation)
                    \subitem Synthesis, theorem provers, etc.
                \item Level of embedding
                \item Extensibility
                    \subitem Multiple interpretations for circuits
                    \subitem User-defined datatypes
            \end{itemize}
