...
\label{sec:edsls}
    ...
    \label{subsec:lava}
        ...
        Lava\cite{lava1998} is an \ac{EDSL} for hardware description developed originally around 1998 at
        ...
        The Lava \ac{EDSL} has several ``dialects'', among which are Xilinx-Lava, York-Lava, Kansas-Lava
    ...
    \label{subsec:coquet}
        ...
        \label{subsubsec:coquet-circuits}
            ...
            There are two \texttt{Obligation}s generated for each \texttt{Rewire} block: one is the
