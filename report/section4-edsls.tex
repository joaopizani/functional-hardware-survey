...
\label{sec:edsls}
    ...
    \label{subsec:lava}
        ...
        instance Eq (Signal a) where
            ...
            more usual \emph{value equality}. This reference equality behaviour is, however, the
            only desirable definition in the context of how Lava represents circuits: a more
            traditional (recursive) definition of equality could result in non-termination when
            inspecting circuits with loops.
