...
\label{sec:edsls}
    ...
    Inductive vec A : nat -> Type :=
        ...
        \label{subsubsec:coquet-modelling}
            ...
            exposed further ahead. A walkthrough of proofs in Coquet, where we explain the
    ...
    Semantics y middles outs
        ...
        \label{subsubsec:coquet-circuits}
            ...
            \begin{itemize}
                ...
                \item We prove the compliance of \texttt{RIPPLE} to a \emph{high-level
                    ...
                    fucntion (as previously), we prove that \texttt{RIPPLE} implements integer
            ...
            procees, we show here the base case ($n = 0$):
            ...
            Now, to finish our walkthrough of Coquet's circuit models and proofs, we will look at a
        ...
        \label{subsubsec:coquet-improv}
            TODO: Closing remarks. Simulation with drawback of not simulating sequential. Great
            verification, actually surpassing the very definition of verification, great genericity
            and great extensibility. Integration with other tools is hard.
