...
package types is
     ...
     type fsvec_int16 is array (fsvec_index range <>) of int16;
     
     subtype fsvec_2_std_logic is fsvec_std_logic (0 to 1);
     
     subtype fsvec_4_int16 is fsvec_int16 (0 to 3);
     ...
     function empty return fsvec_int16;
     
     function length (vec : fsvec_int16)
                     return natural;
     
     function isnull (vec : fsvec_int16)
                     return boolean;
     
     function replace (vec : fsvec_int16;
                       i : natural;
                       a : int16)
                      return fsvec_int16;
     
     function head (vec : fsvec_int16)
                   return int16;
     
     function last (vec : fsvec_int16)
                   return int16;
     
     function init (vec : fsvec_int16)
                   return fsvec_int16;
     
     function tail (vec : fsvec_int16)
                   return fsvec_int16;
     ...
     function shiftl (vec : fsvec_int16;
                      a : int16)
                     return fsvec_int16;
     
     function shiftr (vec : fsvec_int16;
                      a : int16)
                     return fsvec_int16;
     
     function rotl (vec : fsvec_int16)
                   return fsvec_int16;
     
     function rotr (vec : fsvec_int16)
                   return fsvec_int16;
     
     function reverse (vec : fsvec_int16)
                      return fsvec_int16;
     ...
     function plusgt (a : int16;
                      vec : fsvec_int16)
                     return fsvec_int16;
     
     function ltplus (vec : fsvec_int16;
                      a : int16)
                     return fsvec_int16;
     
     function plusplus (vec1 : fsvec_int16;
                        vec2 : fsvec_int16)
                       return fsvec_int16;
     
     function singleton (a : int16)
                        return fsvec_int16;
     
     function show (vec : fsvec_int16)
                   return string;
     
     function default return fsvec_int16;
...
package body types is
     ...
     function sel (f : natural;
                   ...
                   s : natural;
                   vec : fsvec_int16)
                  return fsvec_int16 is
          variable res : fsvec_int16 (0 to n - 1);
     begin
          for i in res'range loop
               res(i) := vec(f + i * s);
          end loop;
     ...
     function empty return fsvec_int16 is
          variable res : fsvec_int16 (0 to -1);
     begin
          return res;
     end;
     ...
     function replace (vec : fsvec_int16;
                       ...
                       a : int16)
                      return fsvec_int16 is
          variable res : fsvec_int16 (0 to vec'length - 1);
     begin
          res := vec(0 to i - 1) & a & vec(i + 1 to vec'length - 1);
          return res;
     end;
     ...
     function init (vec : fsvec_int16)
                   return fsvec_int16 is
          variable res : fsvec_int16 (0 to vec'length - 2);
     begin
          res := vec(0 to vec'length - 2);
          return res;
     end;
     ...
     function drop (n : natural;
                    vec : fsvec_int16)
                   return fsvec_int16 is
          variable res : fsvec_int16 (0 to vec'length - n - 1);
     begin
          res := vec(n to vec'length - 1);
          return res;
     end;
     ...
     function copy (n : natural;
                    a : int16)
                   return fsvec_int16 is
          variable res : fsvec_int16 (0 to n - 1) := (others => a);
     begin
          return res;
     end;
     ...
     function plusgt (a : int16;
                      vec : fsvec_int16)
                     return fsvec_int16 is
          variable res : fsvec_int16 (0 to vec'length);
     begin
          res := a & vec;
          return res;
     end;
     ...
     function plusplus (vec1 : fsvec_int16;
                        vec2 : fsvec_int16)
                       return fsvec_int16 is
          variable res : fsvec_int16 (0 to vec1'length + vec2'length - 1);
     begin
          res := vec1 & vec2;
          return res;
     end;
     ...
     function singleton (a : int16)
                        return fsvec_int16 is
          variable res : fsvec_int16 (0 to 0) := (others => a);
     begin
          return res;
     end;
     ...
     function show (vec : fsvec_int16)
                   return string is
          function doshow (vec : fsvec_int16)
                          return string is
          begin
               case vec'length is
                    when 0 =>
     ...
     function default return fsvec_int16 is
     begin
          return empty;
     end;
