...
\end{frame}
    ...
    \label{sec:modeled-circuits}
        ...
        \label{subsec:circuit-choice-criteria}
            \begin{frame}
                ...
                \begin{itemize}
                    ...
                    \item Well-defined, available specification
                \end{itemize}
            \end{frame}
            ...
            \begin{frame}
                ...
                We cherry-picked circuits from the book ``Elements of Computing Systems'',
                as they satisfied all of our demands.

                \begin{figure}[h!]
                    \includegraphics[width=0.5\textwidth]{imgs/book-cover-elements.jpg}
                    \caption{``Elements of Computing Systems'' - Noam Nisan, Shimon Schocken,
        ...
        \label{subsec:memory-bank}
            \begin{frame}
                \frametitle{Memory bank block diagram}
